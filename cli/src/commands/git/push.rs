...
pub fn cmd_git_push(
    ...
    let num_updated_signatures;
    let num_rebased_descendants: usize;
    match (args.dry_run, sign_behavior) {
        (false, Some(sign_behavior)) => {
            num_updated_signatures = commits_to_sign.len();
